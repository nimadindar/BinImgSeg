...
def fg_proportion_by_image(gt_dir, out_dir="analysis_outputs",
    ...
    csv_path = os.path.join("Data_Analysis",out_dir, "fg_proportion_per_image.csv")
    ...
    if show: plt.show()
        ...
        p1 = os.path.join("Data_Analysis",out_dir, "fg_prop_scatter_unsorted.png")
    ...
    if show: plt.show()
        ...
        p2 = os.path.join("Data_Analysis",out_dir, "fg_prop_scatter_sorted.png")
    ...
    try:
        ...
        if show: plt.show()
            ...
            p3 = os.path.join("Data_Analysis",out_dir, "fg_prop_scatter_clusters.png")
...
rows, fg_props = fg_proportion_by_image("dataset/train/ground_truth",
